...
public class NumberPicker extends LinearLayout implements OnClickListener, OnFocusChangeListener,
	...
	public boolean onLongClick(View v) {
		...
		/*
		 * The text view may still have focus so clear it's focus which will trigger
		 * the on focus changed and any typed values to be pulled.
		 */
		mText.clearFocus();
	...
	private class NumberRangeKeyListener extends NumberKeyListener {
		...
		public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart,
			...
			/*
			 * Ensure the user can't type in a value greater than the max allowed. We
			 * have to allow less than min as the user might want to delete some
