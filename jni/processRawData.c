/*
 * Code provided by open-tuner app, and slightly modified here.
 *
 * https://code.google.com/p/open-guitar/source/browse/trunk/jni/processRawData.c
 *
 */
...
#define  LOG(x...)  __android_log_print(ANDROID_LOG_ERROR,"NDK-LOG",x)
...
jdouble normalizeFreq(jdouble hz) {
	while (hz < 82.41) {
		hz *= 2;
	}
	while (hz > 164.81) {
